...
def createTopo(topo, coreSwitch, aggrSwitch, edgeSwitch, coreSwitchNumber, aggrSwitchNumber, edgeSwitchNumber):
    ...
    c3 = net.addController("controller", controller=RemoteController, ip=controllerIP3, port=6633)
    c4 = net.addController("controller", controller=RemoteController, ip=controllerIP4, port=6633)
